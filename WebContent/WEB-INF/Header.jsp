					...
					<div class="header_right">
									...
									<div id="loginContainer">
										...
										<div id="loginBox">
											<form id="loginForm">
												...
												<span><a href="/OnlineDVDRentals/register">Forgot your password?</a></span>
											</form>
										</div>
									</div>
								</div>
						...
						<div class="search">
							<form action="doSearch" method="post">
								<input type="text" name="searchText"  value="" placeholder="search..."> <input
									type="submit" value="">
							</form>
						</div>
						<div class="clearfix"></div>
